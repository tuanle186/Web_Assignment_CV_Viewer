...
$resumes = mysqli_query($conn, "SELECT * FROM resumes");
?>
<div class="container d-flex flex-column align-items-center" id="resumeContainer">
  <table class="table border-5 rounded-3 overflow-hidden">
    ...
    <!-- Hiển thị 5 sản phẩm ban đầu -->
    <?php
    $limit = 5;
    $query = "SELECT * FROM resumes LIMIT $limit";
  ...
  $(document).ready(function () {
    ...
    function loadResults() {
      $.ajax({
        type: "POST",
        url: "load-more.php",
        data: { searchTerm: searchTerm, limit: limit, offset: offset },
